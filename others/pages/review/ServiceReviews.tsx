        ...
        <div>
            ...
            <div>
                <input
                    ...
                    className="w-full p-2 mt-4 rounded-lg bg-muted"
                />
                ...
                <button
                    ...
                    className="w-full px-4 py-2 mt-4 font-bold transition duration-300 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90"
                >
                ...
                {isEditing && (
                    <button
                        ...
                        className="w-full px-4 py-2 mt-2 font-bold text-white transition duration-300 bg-red-500 rounded-lg hover:bg-red-400"
                    >
                        Delete Review
                    </button>
                )}
