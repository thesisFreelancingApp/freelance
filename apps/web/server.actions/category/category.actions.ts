...
//   const category = await prisma.mainCategories.findUnique({
//     where: { id },
...
//   const category = await prisma.mainCategories.create({
//     data,
//   });
//   return category;
// };
...
// ) => {
//   const category = await prisma.mainCategories.update({
//     where: { id },
//     data,
//   });
//   return category;
...
//   const category = await prisma.mainCategories.delete({
//     where: { id },
//   });
//   return category;
// };
...
export const getCategories = async () => {
  return prisma.mainCategories.findMany({
    where: { level: 1 },
    include: {
      children: {
        include: {
...
//   return prisma.mainCategories.findFirst({
