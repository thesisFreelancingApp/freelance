...
const faqs = [
  ...
  {
    question: "Qu'est-ce qui différencie WaiaHive des autres plateformes ?",
    answer:
      "WaiaHive offre une grande variété de services et est particulièrement adapté pour des tâches spécifiques à des tarifs compétitifs.",
  },
  {
    question: "Combien coûte l'inscription sur WaiaHive ?",
    answer:
      "L'inscription sur WaiaHive est gratuite. Cependant, des frais peuvent être appliqués lors de la transaction pour certaines prestations.",
  },
  {
    question: "Comment puis-je communiquer avec mon freelance ?",
    answer:
      "Vous pouvez utiliser la messagerie intégrée de WaiaHive pour discuter avec votre freelance et suivre l'avancement de votre projet.",
  },
  {
    question: "Quels sont les modes de paiement proposés par WaiaHive ?",
    answer:
      "WaiaHive accepte les paiements via carte de crédit, PayPal et d'autres méthodes de paiement sécurisées.",
  },
  {
    question:
      "Comment savoir si le résultat obtenu est à la hauteur du prix payé ?",
    answer:
      "WaiaHive permet aux utilisateurs de noter et de laisser des commentaires après chaque service, ce qui vous aide à évaluer la qualité des freelances.",
  },
  {
    question:
      "Qui dois-je contacter si j'ai des problèmes avec une mission ou un freelance ?",
    answer:
      "Vous pouvez contacter le service client de WaiaHive pour toute assistance ou pour résoudre des conflits avec des freelances.",
  },
  {
    question: "Puis-je également travailler avec des freelances francophones ?",
    answer:
      "Oui, WaiaHive propose des freelances de différents pays, y compris des pays francophones.",
  },
];
